...
def upload_to_redcap_data(conn_str, questionnaire, old_2_redcap_map):
    ...
    cur.execute("""UPDATE  auxiliary_questionnaires_data.redcap_data_questionnaires_columns_names
...
def add_name_mapping_to_database(conn_str, questionnaires_cluster, columns_range_mapping, transformation_function,
    ...
    upload_to_db(questionnaires_cluster, conn_str, upload_to_old_data, old_data_2_imputation_data_mapping, "old_data_questionnaires_columns_names")
    upload_to_db(questionnaires_cluster, conn_str, upload_to_redcap_data, redcap_data_2_old_data_mapping, "redcap_data_questionnaires_columns_names")
...
def add_column_names_mapping(conn_str):
    ...
    columns_range_mapping = {
        ...
        'imputation_data_start_column': 'wai_immirisk_timestamp',
        'imputation_data_end_column': 'cssrs_t_complete',
